...
define("ember-dialog",
  ...
  function(__dependency1__, __exports__) {
    ...
    /**
      ...
      @module ember
      @submodule ember-dialog
    */
    var Manager = __dependency1__["default"];

    __exports__["default"] = {
      Manager: Manager
    };
  });
define("ember-dialog/component",
  ["ember-dialog/utils","exports"],
  function(__dependency1__, __exports__) {
    "use strict";
    var maxZIndex = __dependency1__["default"];
...
define("ember-dialog/manager",
  ["ember-dialog/component","exports"],
  function(__dependency1__, __exports__) {
    "use strict";
    var DialogComponent = __dependency1__["default"];
    ...
    __exports__["default"] = Ember.Object.extend(Ember.Evented, {
        ...
        */
        open: function(name, view, controller, dialogData, setActive) {
            ...
            Ember.assert('Component not provided to dialog manager!', component);
            ...
            if (Ember.typeOf(dialog) === 'undefined') {
                ...
                dialog = this.get('component').createWithMixins(data);
...
define("ember-dialog/utils",
  ...
  function(__exports__) {
    ...
    __exports__.maxZIndex = maxZIndex;
  });
 global.EmberDialog = requireModule('ember-dialog')['default'];
 })(this);