...
var libFiles = moveFromLibAndMainJs('ember-dialog', false);
...
var namedAMDBuild = concat(libFiles, {
  inputFiles: ['**/*.js'],
  separator: '\n',
  outputFile: '/ember-dialog.named-amd.js'
});
...
if (env !== 'production') {
  var testFiles = testTree(libFiles, 'ember-dialog');
  ...
  var minifiedAMD = minify(namedAMDBuild, 'ember-dialog.named-amd');
